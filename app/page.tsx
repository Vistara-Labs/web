    ...
    <div style={{ ...containerStyle, color: '#fff', minHeight: '100vh' }}>
        ...
        <main style={{ padding: '20px' }}>
            ...
            <section style={{ ...sectionStyle, marginTop: '20px' }}>
                ...
                {/* <p>
                  Socials:
                  <a href="https://twitter.com/vistaralabs" target="_blank" rel="noopener noreferrer">
                      <img height={40} width={40} src="https://pbs.twimg.com/profile_images/1683899100922511378/5lY42eHs_400x400.jpg" alt="Vistara" />
                  </a>
                  <a href="https://discord.gg/D4kJkCAgQE" target="_blank">
                    <img height={40} width={40} src="https://pbs.twimg.com/profile_images/1605995588297773056/E9xyyqqA_400x400.jpg" alt="Vistara Discord" />
                  </a>
                </p> */}

                {/* <p style={{ fontSize: '1.1em' }}>Bridge the gap between vision and innovation in the decentralized world with Vistara.</p> */}
            </section>
